   ...
   https://www.youtube.com/watch?v=uEUXGcc2VXM&t=266s&ab_channel=AbdulBari
    ...
    Also binarySearchIterativeNext   will find the next larger elements compare to the target
    Also binarySearchIterativeBefore will find  one smaller elements compare to the target
